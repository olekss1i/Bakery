        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Distributor_Country_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Country",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_Country_OriginCountryId",
                        column: x => x.OriginCountryId,
                        principalTable: "Country",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ingredients_Distributor_DistributorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_DistributorId",
                table: "Ingredients",
                column: "DistributorId");

            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_OriginCountryId",
                table: "Ingredients",
